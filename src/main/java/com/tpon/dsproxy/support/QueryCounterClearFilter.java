...
/**
 * Servlet filter to clear the {@link com.tpon.dsproxy.QueryCount} stored in thread local at the end of the
 * http servlet request lifecycle when {@link com.tpon.dsproxy.listener.DataSourceQueryCountListener} is used.
 *
