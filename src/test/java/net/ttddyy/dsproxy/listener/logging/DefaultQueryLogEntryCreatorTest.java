...
public class DefaultQueryLogEntryCreatorTest {
    ...
    public void getLogEntryForStatement() throws Exception {
        ...
        String entry = creator.getLogEntry(executionInfo, true, true);
        ...
        entry = creator.getLogEntry(executionInfo, false, true);
        ...
        entry = creator.getLogEntry(executionInfo, true, false);
        ...
        entry = creator.getLogEntry(executionInfo, false, false);
        ...
        entry = creator.getLogEntry(executionInfo, true, true);
    ...
    public void statementType() throws Exception {
        ...
        result = creator.getLogEntry(executionInfo, true, true);
    ...
    public void formatQuery() throws Exception {
        ...
        executionInfo.setQueries(Arrays.asList(select));
        String result = creator.getLogEntry(executionInfo, true, true);
